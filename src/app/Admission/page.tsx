...
const PatientAdmissionForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    const treatmentRecords = [
      {
        treatment_for: formData.treatment_for,
        date: formData.date,
    ...
    <div className="p-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          <input type="text" name="mobile" className="input" value={formData.mobile} onChange={handleChange} />
        </div>
        <div className="md:col-span-2">
          <label className="block mb-1">Address</label>
          <input type="text" name="address" className="input w-full" value={formData.address} onChange={handleChange} />
        </div>

        <div>
          <label className="block mb-1">Treatment For</label>
          <input type="text" name="treatment_for" className="input" value={formData.treatment_for} onChange={handleChange} />
        </div>
        ...
        <div>
          ...
          <input type="text" name="roomNo" className="input" value={formData.room.roomNo} onChange={(e) => handleChange(e, 'room')} />
        </div>

        <div>
          <label className="block mb-1">Bed Number</label>
          <input type="text" name="bedNo" className="input" value={formData.room.bedNo} onChange={(e) => handleChange(e, 'room')} />
        </div>

        <div>
          <label className="block mb-1">Room Category</label>
          <select name="roomCategory" className="input" value={formData.room.roomCategory} onChange={(e) => handleChange(e, 'room')}>
        ...
        <div>
          ...
          <input type="number" name="roomPrice" className="input" value={formData.room.roomPrice} onChange={(e) => handleChange(e, 'room')} />
        </div>

        <div>
          <label className="block mb-1">Bottle Count</label>
          <input type="number" name="count" className="input" value={formData.bottles.count} onChange={(e) => handleChange(e, 'bottles')} />
        </div>

        <div>
          <label className="block mb-1">Bottle Price</label>
          <input type="number" name="price" className="input" value={formData.bottles.price} onChange={(e) => handleChange(e, 'bottles')} />
        </div>

        <div>
          <label className="block mb-1">Injection Count</label>
          <input type="number" name="count" className="input" value={formData.injections.count} onChange={(e) => handleChange(e, 'injections')} />
        </div>

        <div>
          <label className="block mb-1">Injection Price</label>
          <input type="number" name="price" className="input" value={formData.injections.price} onChange={(e) => handleChange(e, 'injections')} />
        </div>

        <div>
          <label className="block mb-1">Doctor Fees</label>
          <input type="number" name="doctorFees" className="input" value={formData.doctorFees} onChange={handleChange} />
        </div>

        <div>
          <label className="block mb-1">Operation Cost</label>
          <input type="number" name="operationCost" className="input" value={formData.operationCost} onChange={handleChange} />
        </div>

        <div>
          <label className="block mb-1">Other Cost</label>
          <input type="number" name="otherCost" className="input" value={formData.otherCost} onChange={handleChange} />
        </div>
      </div>
